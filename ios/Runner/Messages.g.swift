...
class NotificationApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: NotificationApi?, messageChannelSuffix: String = "") {
    ...
    let showNotificationChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.posts_challenge.NotificationApi.showNotification\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
...
/// Generated protocol from Pigeon that represents a handler of messages from Flutter.
protocol NotificationPermissionApi {
  func requestPermission(completion: @escaping (Result<Bool, Error>) -> Void)
  func checkPermission() throws -> Bool
}

/// Generated setup class from Pigeon to handle messages through the `binaryMessenger`.
class NotificationPermissionApiSetup {
  static var codec: FlutterStandardMessageCodec { MessagesPigeonCodec.shared }
  /// Sets up an instance of `NotificationPermissionApi` to handle messages through the `binaryMessenger`.
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: NotificationPermissionApi?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let requestPermissionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.posts_challenge.NotificationPermissionApi.requestPermission\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
    ...
    let checkPermissionChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.posts_challenge.NotificationPermissionApi.checkPermission\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
